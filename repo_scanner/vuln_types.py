...
VULN_TYPES: dict[str, VulnTypeSpec] = {
    ...
    "sql_injection": VulnTypeSpec(
        id="sql_injection",
        title="SQL Injection",
        description="Dynamic SQL in code plus library CVEs classified as CWE-89",
    ...
    "command_injection": VulnTypeSpec(
        ...
        description="Shell/process execution in code plus library CVEs (CWE-78/94)",
    ...
    "deserialization": VulnTypeSpec(
        ...
        description="pickle, unsafe YAML, marshal, BinaryFormatter, plus library CWE-502 CVEs",
    ...
    "denial_of_service": VulnTypeSpec(
        ...
        # deps/ findings for DoS are matched via category/policy denial_of_service (not deps/ prefix),
        # so other CVE classes do not leak into --only dos.
    ...
    "dependencies": VulnTypeSpec(
        ...
        description="All known CVEs in NuGet/npm/PyPI packages and lockfiles (Snyk Open Source style)",
    ...
    "null_pointer": VulnTypeSpec(
        ...
        description="SAST null paths plus library CVEs classified as CWE-476",
    ...
    "ssrf": VulnTypeSpec(
        ...
        description="HTTP clients with user-controlled URLs plus library SSRF CVEs (CWE-918)",
        categories=frozenset({"ssrf"}),
        policies=frozenset({"ssrf"}),
